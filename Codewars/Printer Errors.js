...
const printerError = (ctrlStr) => {
  ...
  return `${errors}/${ctrlStr.length}`;
};

let test1 = "aaaxbbbbyyhwawiwjjjwwm"; // Output: 8/22
let test2 = "aaaaaaaaaaaaaaaabbbbbbbbbbbbbbbbbbmmmmmmmmmmmmmmmmmmmxyz"; // Output: 3/56
let test3 = "aaaxbbbyhmamiwjjwwm"; // Output: 6/19

console.log(printerError(test3));
